...
?>
    ...
    <div class="container">
        ...
        <!-- Agrega este script al final del <head> -->
        <script>
        ...
        seleccionarButtons.forEach(function(button) {
            button.addEventListener("click", function(event) {
                ...
                // Agregar los detalles a la tabla de facturación con el precio con descuento
                var filaNueva = "<tr>" +
                "<td>" + producto + "</td>" +
                "<td>" + descripcion + "</td>" +
                "<td>" + categoria + "</td>" +
                ...
                "<td><div><a href='' class='eliminar' style='color:red; text-decoration: none; cursor: pointer;'><span style='font-weight: bold;'><strong>Eliminar</strong></span></a></div></td>" +
                "</tr>";
                ...
                enlacesEliminar.forEach(function(enlace) {
                    enlace.addEventListener("click", function(event) {
                        ...
                        filaPadre.remove(); // Eliminar la fila del DOM 
                        ...
                        nuevasFilas.forEach(function(nuevaFila) {
                            var totalFila = parseFloat(nuevaFila.querySelector("td:nth-child(7)").textContent);
            ...
            <div style="overflow-y: auto; max-height: 620px; width: 750px; margin-right: -50px;">
...
<script>
    ...
    function agregarProducto(elemento) {
        ...
        <div class="AFacturarProductoServicio" style="position: center ; margin-top: 60px; margin-left: 40px;">
        ...
        <!-- <button onclick="agregarFilasAMatriz()">Agregar Filas a Matriz</button> -->
        ...
        <div class="right-column"></div>        
            <form id="formularioFactura" action="GenerarFactura.php" method="post" style="margin-right: 10px; margin-top: 20px;">                

                <input type="hidden" name="IdPaciente" value="<?php echo $id; ?>">


                <input type="hidden" id="edad" name="edad" style="font-size: 15px;" required value="<?php echo $edad; ?>">  <!-- input de la edad del paciente  -->

                <label for="nombre" style="font-weight: bold;">Nombre y Apellido del Paciente:</label>
                <input type="text" id="nombre" name="nombre" style="font-size: 15px;" required readonly value="<?php echo $nombre." ".$apellido;?>">
                
                <label style="font-weight: bold;">Cédula del Paciente:</label>
                <input type="text" id="cedula" name="cedula" style="font-size: 15px;" required readonly value="<?php echo $cedula; ?>">

                <label for="fecha" style="font-weight: bold;">Fecha:</label>
                <input type="text" id="fechaConsulta" name="fechaConsulta"style="font-size: 15px;" required readonly>
                ...
                var formattedDate = (dia < 10 ? '0' : '') + dia + '/' + (mes < 10 ? '0' : '') + mes + '/' + año;
