...
<body>
<!-- autocomplete="on" -->
<form class="jotform-form" onsubmit="return typeof testSubmitFunction !== 'undefined' && testSubmitFunction();"  action="AgregaFormularioReceta.php" method="POST" name="form_240483924998877" id="240483924998877" accept-charset="utf-8" onsubmit="return validarFormulario();" style="background-color: white;" >
  ...
  <div role="main" class="form-all">
    <ul class="form-section page-section">
      ...
      <!-- action="https://submit.jotform.com/submit/240483924998877" -->

      <!-- FECHA -->
      <li class="form-line form-line-column form-col-1 form-line-column-clear" data-type="control_datetime" id="id_19">
        <label class="form-label form-label-top" id="label_19" for="lite_mode_19" aria-hidden="false"> Fecha de Creación</label>
        <div id="cid_19" class="form-input-wide" data-layout="half">
          <div data-wrapper-react="true">
            ...
            <input type="tel" class="form-textbox validate[disallowPast, limitDate]" id="day_19" name="q19_fecha[day]" size="2" data-maxlength="2" data-age="" maxLength="2" value="" autoComplete="off" aria-labelledby="label_19 sublabel_19_day" />
            <span class="date-separate" aria-hidden="true"> -</span><label class="form-sub-label" for="day_19" id="sublabel_19_day" style="min-height:13px">Día</label>
          </span><span class="form-sub-label-container" style="vertical-align:top"><input type="tel" class="form-textbox validate[disallowPast, limitDate]" id="month_19" name="q19_fecha[month]" size="2" data-maxlength="2" data-age="" maxLength="2" value="" autoComplete="off" aria-labelledby="label_19 sublabel_19_month" />
          <span class="date-separate" aria-hidden="true"> -</span><label class="form-sub-label" for="month_19" id="sublabel_19_month" style="min-height:13px">Mes</label></span><span class="form-sub-label-container" style="vertical-align:top">
          <input type="tel" class="form-textbox validate[disallowPast, limitDate]" id="year_19" name="q19_fecha[year]" size="4" data-maxlength="4" data-age="" maxLength="4" value="" autoComplete="off" aria-labelledby="label_19 sublabel_19_year" />
          <label class="form-sub-label" for="year_19" id="sublabel_19_year" style="min-height:13px">Año</label></span></div><span class="form-sub-label-container" style="vertical-align:top">
          <input type="text" class="form-textbox validate[disallowPast, limitDate, validateLiteDate]" id="lite_mode_19" size="12" data-maxlength="12" maxLength="12" data-age="" value="" data-format="ddmmyyyy" data-seperator="-" placeholder="DD-MM-YYYY" data-placeholder="DD-MM-YYYY" autoComplete="off" aria-labelledby="label_19 sublabel_19_litemode" />
          <img class="showAutoCalendar newDefaultTheme-dateIcon icon-liteMode" alt="Pick a Date" id="input_19_pick" src="https://cdn.jotfor.ms/images/calendar.png" data-component="datetime" aria-hidden="true" data-allow-time="No" data-version="v2" />
          <label class="form-sub-label" for="lite_mode_19" id="sublabel_19_litemode" style="min-height:13px">Fecha</label></span>
          </div>
        </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-6" data-type="control_dropdown" id="id_66">
        ...
        <div id="cid_66" class="form-input-wide" data-layout="half"> 
          <select class="form-dropdown" id="input_66" name="q66_posicionPrimaria66" style="width:310px" data-component="dropdown" aria-label="Posición Primaria de Mirada (PPM):"  onchange="actualizarCedula()" placeholder="Elige Paciente">

           <?php
            include("Conexion.php");

              $getPacientes1 = "select * from pacientes order by IdPaciente";
              $getPacientes2 = mysqli_query($conn, $getPacientes1); // Asumiendo que $conn es tu conexión a la base de datos

              while($row = mysqli_fetch_array($getPacientes2)) {
              $id = $row['IdPaciente'];
              $nombre = $row['Nombre'];
              ...
              $edad = $row['Edad'];
              $numeroTelefono = $row['Celular'];
              $email = $row['Email'];
              ?>
              <option value="<?php echo $cedula . '|' . $nombre . '|' . $apellido . '|' . $fechaNacimiento . '|' . $edad . '|' . $numeroTelefono . '|' . $numeroTelefono . '|' . $email; ?>"><?php echo $nombre. " ".$apellido; ?></option>
              <?php
              }
              ?>
          </select> 
      ...
      <script>
        ...
        var pacienteSeleccionado = document.getElementById("input_66").value;
    
        // Asignar el valor del paciente seleccionado al campo de cédula
        var partes = pacienteSeleccionado.split('|');
            // Asignar cada parte a los campos correspondientes
            document.getElementById("prefix_4").value = partes[0]; //Cedula
            document.getElementById("first_4").value = partes[1]; //Nombre
            document.getElementById("last_4").value = partes[2];//Apellido
            document.getElementById("input_100").value = partes[3]; //Fecha de Nacimiento
            document.getElementById("input_10").value = partes[4]; //Edad
            document.getElementById("input_7_phone").value = partes[5]; //Celular /Numero de telefono
            document.getElementById("input_11").value = partes[7];//Email

        // document.getElementById("prefix_4").value = pacienteSeleccionado;
        // document.getElementById("first_4").value = pacienteSeleccionado;
        // document.getElementById("last_4").value = pacienteSeleccionado;
        // document.getElementById("lite_mode_5").value = pacienteSeleccionado;
        // document.getElementById("input_10").value = pacienteSeleccionado;
        // document.getElementById("input_7_phone").value = pacienteSeleccionado;
        // document.getElementById("input_11").value = pacienteSeleccionado;
        }
      </script>
      ...
      <ul class="form-section-closed" style="height: 84px;clear:both;" id="section_33">
        ...
        <li class="form-line jf-required" data-type="control_fullname" id="id_4" data-compound-hint=",,">
          ...
          <div id="cid_4" class="form-input-wide jf-required" data-layout="full">
            <div data-wrapper-react="true" class="extended"><span class="form-sub-label-container" style="vertical-align:top" data-input-type="prefix">
                ...
                <input data-component="prefix" name="q4_paciente" id="prefix_4" class="dropdown-match-height form-dropdown validate[required] no-arrow" aria-labelledby="label_4 sublabel_4_prefix" autoComplete="section-input_4 honorific-prefix" onchange="actualizarCedula()" >
                ...
                <input type="text" id="first_4" name="q4_pacienteNombre" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_4 given-name" size="10" data-component="first" aria-labelledby="label_4 sublabel_4_first" required=""/>
                ...
                <input type="text" id="last_4" name="q4_pacienteApellido" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_4 family-name" size="15" data-component="last" aria-labelledby="label_4 sublabel_4_last" required=""/>
        ...
        <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_10">
          ...
          <div id="cid_10" class="form-input-wide" data-layout="half"> 
            <input type="date" id="input_100" name="q10_edadd" data-type="input-textbox" class="form-textbox validate[Numeric]" data-defaultvalue="" style="width:310px" size="310" maxLength="2" data-component="textbox" aria-labelledby="label_10" value="" /> 
            <label class="form-sub-label" for="input_7_phone" id="sublabel_7_phone" style="min-height:13px">Fecha Nacimiento</label>
          </div>
        </li>

        <!-- <li class="form-line form-line-column form-col-1 jf-required" data-type="control_datetime" id="id_5"><label class="form-label form-label-top" id="label_5" for="lite_mode_5" aria-hidden="false"> Fecha de Nacimiento<span class="form-required">*</span> </label>
          <div id="cid_5" class="form-input-wide jf-required" data-layout="half">
            <div data-wrapper-react="true">
              <div style="display:none"><span class="form-sub-label-container" style="vertical-align:top">
              <input type="tel" class="form-textbox validate[required, limitDate]" id="day_5" name="q5_fechaDe5[day]" size="2" data-maxlength="2" data-age="2" maxLength="2" value="" required="" autoComplete="off" aria-labelledby="label_5 sublabel_5_day" />
              <span class="date-separate" aria-hidden="true"> -</span><label class="form-sub-label" for="day_5" id="sublabel_5_day" style="min-height:13px">Día</label></span><span class="form-sub-label-container" style="vertical-align:top">
              <input type="tel" class="form-textbox validate[required, limitDate]" id="month_5" name="q5_fechaDe5[month]" size="2" data-maxlength="2" data-age="2" maxLength="2" value="" required="" autoComplete="off" aria-labelledby="label_5 sublabel_5_month" />
              <span class="date-separate" aria-hidden="true"> -</span><label class="form-sub-label" for="month_5" id="sublabel_5_month" style="min-height:13px">Mes</label></span><span class="form-sub-label-container" style="vertical-align:top">
              <input type="tel" class="form-textbox validate[required, limitDate]" id="year_5" name="q5_fechaDe5[year]" size="4" data-maxlength="4" data-age="2" maxLength="4" value="" required="" autoComplete="off" aria-labelledby="label_5 sublabel_5_year" />
              <label class="form-sub-label" for="year_5" id="sublabel_5_year" style="min-height:13px">Año</label></span></div><span class="form-sub-label-container" style="vertical-align:top">
              <input type="text" class="form-textbox validate[required, limitDate, validateLiteDate]" id="lite_mode_5" size="12" data-maxlength="12" maxLength="12" data-age="2" value="" required="" data-format="ddmmyyyy" data-seperator="-" placeholder="DD-MM-YYYY" data-placeholder="DD-MM-YYYY" autoComplete="off" aria-labelledby="label_5 sublabel_5_litemode" />
              <img class=" newDefaultTheme-dateIcon icon-liteMode" alt="Pick a Date" id="input_5_pick" src="https://cdn.jotfor.ms/images/calendar.png" data-component="datetime" aria-hidden="true" data-allow-time="No" data-version="v2" />
              <label class="form-sub-label" for="lite_mode_5" id="sublabel_5_litemode" style="min-height:13px">Fecha</label></span>
            </div>
          </div>
        </li> -->
        ...
        <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_10">
          ...
          <div id="cid_10" class="form-input-wide" data-layout="half"> 
            <input type="text" id="input_10" name="q10_edad" data-type="input-textbox" class="form-textbox validate[Numeric]" data-defaultvalue="" style="width:310px" size="310" maxLength="2" data-component="textbox" aria-labelledby="label_10" value="" /> 
          ...
          <div id="cid_7" class="form-input-wide jf-required" data-layout="half">
            <div data-wrapper-react="true"><span class="form-sub-label-container" style="vertical-align:top" data-input-type="areaCode">
              <span class="form-sub-label-container" style="vertical-align:top" data-input-type="phone">
                <input type="tel" id="input_7_phone" name="q7_numeroDeTelefono" class="form-textbox validate[required]" data-defaultvalue=""  data-component="phone" aria-labelledby="label_7 sublabel_7_phone" required="" value="" />
        ...
        <li class="form-line form-line-column form-col-4 jf-required" data-type="control_email" id="id_11"><label class="form-label form-label-top" id="label_11" for="input_11" aria-hidden="false"> Email<span class="form-required">*</span> </label>
          <div id="cid_11" class="form-input-wide jf-required" data-layout="half"> 
            <input type="text" id="input_11" name="q11_email" class="form-textbox validate[required, Email]" data-defaultvalue="" autoComplete="section-input_11 email" style="width:310px" size="310" data-component="email" aria-labelledby="label_11" required="" value="" /> 
      ...
      <ul class="form-section-closed" style="height: 84px;clear:both;" id="section_34">
        ...
        <li class="form-line jf-required" data-type="control_textarea" id="id_14">
          ...
          <div id="cid_14" class="form-input-wide jf-required" data-layout="full">
            <div class="form-textarea-limit"><span>
              <textarea id="input_14" class="form-textarea validate[required]" name="q14_motivoDe" style="width:648px;height:163px" data-component="textarea" required="" aria-labelledby="label_14"></textarea>
        ...
        <li class="form-line jf-required" data-type="control_textarea" id="id_16"><label class="form-label form-label-top form-label-auto" id="label_16" for="input_16" aria-hidden="false"> Historias de enfermedades actuales<span class="form-required">*</span> </label>
          <div id="cid_16" class="form-input-wide jf-required" data-layout="full">
            <div class="form-textarea-limit"><span>
              <textarea id="input_16" class="form-textarea validate[required]" name="q16_historiasDe" style="width:648px;height:163px" data-component="textarea" required="" aria-labelledby="label_16"></textarea>
        ...
        <li class="form-line jf-required" data-type="control_datetime" id="id_18"><label class="form-label form-label-top form-label-auto" id="label_18" for="lite_mode_18" aria-hidden="false"> Último control visual<span class="form-required">*</span> </label>
          <div id="cid_18" class="form-input-wide jf-required" data-layout="half">
            <div data-wrapper-react="true">
              ...
              <input type="text" class="form-textbox validate[required, limitDate, validateLiteDate]" id="lite_mode_18" size="12" data-maxlength="12" maxLength="12" data-age="" value="" required="" data-format="ddmmyyyy" data-seperator="-" placeholder="DD-MM-YYYY" data-placeholder="DD-MM-YYYY" autoComplete="off" aria-labelledby="label_18 sublabel_18_litemode" /><img class=" newDefaultTheme-dateIcon icon-liteMode" alt="Pick a Date" id="input_18_pick" src="https://cdn.jotfor.ms/images/calendar.png" data-component="datetime" aria-hidden="true" data-allow-time="No" data-version="v2" /><label class="form-sub-label" for="lite_mode_18" id="sublabel_18_litemode" style="min-height:13px">Fecha</label></span>
            </div>
          </div>
        </li>
        ...
        <li class="form-line jf-required" data-type="control_textarea" id="id_20"><label class="form-label form-label-top form-label-auto" id="label_20" for="input_20" aria-hidden="false"> Antecedentes patológicos personales<span class="form-required">*</span> </label>
          <div id="cid_20" class="form-input-wide jf-required" data-layout="full">
            <div class="form-textarea-limit"><span>
              <textarea id="input_20" class="form-textarea validate[required]" name="q20_antecedentesPatologicos" style="width:648px;height:163px" data-component="textarea" required="" aria-labelledby="label_20"></textarea>
        ...
        <li class="form-line jf-required" data-type="control_textarea" id="id_21"><label class="form-label form-label-top form-label-auto" id="label_21" for="input_21" aria-hidden="false"> Antecedentes patológicos oculares<span class="form-required">*</span> </label>
          <div id="cid_21" class="form-input-wide jf-required" data-layout="full">
            <div class="form-textarea-limit"><span>
              <textarea id="input_21" class="form-textarea validate[required]" name="q21_antecedentesPatologicos21" style="width:648px;height:163px" data-component="textarea" required="" aria-labelledby="label_21"></textarea>
        ...
        <li class="form-line jf-required" data-type="control_textarea" id="id_22"><label class="form-label form-label-top form-label-auto" id="label_22" for="input_22" aria-hidden="false"> Antecedentes patológicos sistémicos y oculares familiares<span class="form-required">*</span> </label>
          <div id="cid_22" class="form-input-wide jf-required" data-layout="full">
            <div class="form-textarea-limit"><span>
              <textarea id="input_22" class="form-textarea validate[required]" name="q22_antecedentesPatologicos22" style="width:648px;height:163px" data-component="textarea" required="" aria-labelledby="label_22"></textarea>
      ...
      <ul class="form-section-closed" style="height: 84px;clear:both;" id="section_32">
          ...
          <div id="cid_25" class="form-input-wide jf-required" data-layout="full">
            <table summary="" aria-labelledby="label_25" cellPadding="4" cellSpacing="0" class="form-matrix-table" data-component="matrix">
              ...
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_25 label_25_row_0">
                ...
                <td class="form-matrix-values"><input type="text" id="input_25_0_0" class="form-textbox validate[required, requireEveryCell]" name="q25_sinCorreccion1" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_25_col_0 label_25_row_0" step="any" aria-label="Cells Text Box" /></td>
                <td class="form-matrix-values"><input type="text" id="input_25_0_1" class="form-textbox validate[required, requireEveryCell]" name="q25_sinCorreccion2" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_25_col_1 label_25_row_0" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_25 label_25_row_1">
                ...
                <td class="form-matrix-values"><input type="text" id="input_25_1_0" class="form-textbox validate[required, requireEveryCell]" name="q25_sinCorreccion11" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_25_col_0 label_25_row_1" step="any" aria-label="Cells Numeric Text Box" /></td>
                <td class="form-matrix-values"><input type="text" id="input_25_1_1" class="form-textbox validate[required, requireEveryCell]" name="q25_sinCorreccion22" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_25_col_1 label_25_row_1" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_25 label_25_row_2">
                ...
                <td class="form-matrix-values"><input type="text" id="input_25_2_0" class="form-textbox validate[required, requireEveryCell]" name="q25_sinCorreccion111" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_25_col_0 label_25_row_2" step="any" aria-label="Cells Numeric Text Box" /></td>
                <td class="form-matrix-values"><input type="text" id="input_25_2_1" class="form-textbox validate[required, requireEveryCell]" name="q25_sinCorreccion222" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_25_col_1 label_25_row_2" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
            </table>
          </div>
        </li>
          ...
          <div id="cid_48" class="form-input-wide jf-required" data-layout="full">
            <table summary="" aria-labelledby="label_48" cellPadding="4" cellSpacing="0" class="form-matrix-table" data-component="matrix">
              ...
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_48 label_48_row_0">
                ...
                <td class="form-matrix-values"><input type="text" id="input_48_0_0" class="form-textbox validate[required, requireEveryCell]" name="q48_conCorreccion1" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_48_col_0 label_48_row_0" step="any" aria-label="Cells Numeric Text Box" /></td>
                <td class="form-matrix-values"><input type="text" id="input_48_0_1" class="form-textbox validate[required, requireEveryCell]" name="q48_conCorreccion2" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_48_col_1 label_48_row_0" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_48 label_48_row_1">
                ...
                <td class="form-matrix-values"><input type="text" id="input_48_1_0" class="form-textbox validate[required, requireEveryCell]" name="q48_conCorreccion11" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_48_col_0 label_48_row_1" step="any" aria-label="Cells Numeric Text Box" /></td>
                <td class="form-matrix-values"><input type="text" id="input_48_1_1" class="form-textbox validate[required, requireEveryCell]" name="q48_conCorreccion22" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_48_col_1 label_48_row_1" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_48 label_48_row_2">
                ...
                <td class="form-matrix-values"><input type="text" id="input_48_2_0" class="form-textbox validate[required, requireEveryCell]" name="q48_conCorreccion111" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_48_col_0 label_48_row_2" step="any" aria-label="Cells Numeric Text Box" /></td>
                <td class="form-matrix-values"><input type="text" id="input_48_2_1" class="form-textbox validate[required, requireEveryCell]" name="q48_conCorreccion222" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_48_col_1 label_48_row_2" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
            </table>
          </div>
        </li>
        ...
        <li class="form-line" data-type="control_textbox" id="id_49"><label class="form-label form-label-top form-label-auto" id="label_49" for="input_49" aria-hidden="false"> Observaciones: </label>
          <div id="cid_49" class="form-input-wide" data-layout="half"> 
            <input type="text" id="input_49" name="q49_observaciones" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" maxLength="250" data-component="textbox" aria-labelledby="label_49" value="" /> </div>
        </li>
        ...
        <li class="form-line form-line-column form-col-3" data-type="control_textbox" id="id_54"><label class="form-label form-label-top" id="label_54" for="input_54" aria-hidden="false"> Observaciones: </label>
          <div id="cid_54" class="form-input-wide" data-layout="half"> 
            <input type="text" id="input_54" name="q54_observaciones54" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" maxLength="250" data-component="textbox" aria-labelledby="label_54" value="" /> </div>
        </li>
        <li class="form-line form-line-column form-col-4" data-type="control_textbox" id="id_65"><label class="form-label form-label-top" id="label_65" for="input_65" aria-hidden="false"> Observaciones: </label>
          <div id="cid_65" class="form-input-wide" data-layout="half">
             <input type="text" id="input_65" name="q65_observaciones65" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" maxLength="250" data-component="textbox" aria-labelledby="label_65" value="" /> </div>
        </li>
        ...
        <li class="form-line form-line-column form-col-9 jf-required" data-type="control_checkbox" id="id_61"><label class="form-label form-label-top" id="label_61" aria-hidden="false"> Ojo derecho<span class="form-required">*</span> </label>
          <div id="cid_61" class="form-input-wide jf-required" data-layout="full">
            ...
            <input type="checkbox" aria-describedby="label_61" class="form-checkbox validate[required]" id="input_61_0" name="q61_ojoDerecho61_1" value="RM" required="" />
            ...
            <input type="checkbox" aria-describedby="label_61" class="form-checkbox validate[required]" id="input_61_1" name="q61_ojoDerecho61_2" value="RL" required="" />
            <label id="label_input_61_1" for="input_61_1">RL</label>

            </span><span class="form-checkbox-item" style="clear:left">
            <span class="dragger-item"></span>
            <input type="checkbox" aria-describedby="label_61" class="form-checkbox validate[required]" id="input_61_2" name="q61_ojoDerecho61_3" value="RI" required="" />
            <label id="label_input_61_2" for="input_61_2">RI</label>
            </span><span class="form-checkbox-item" style="clear:left">
            <span class="dragger-item"></span>

            <input type="checkbox" aria-describedby="label_61" class="form-checkbox validate[required]" id="input_61_3" name="q61_ojoDerecho61_4" value="RS" required="" />
            <label id="label_input_61_3" for="input_61_3">RS</label>
            </span><span class="form-checkbox-item" style="clear:left">
            <span class="dragger-item"></span>
            <input type="checkbox" aria-describedby="label_61" class="form-checkbox validate[required]" id="input_61_4" name="q61_ojoDerecho61_5" value="OI" required="" />
            ...
            <input type="checkbox" aria-describedby="label_61" class="form-checkbox validate[required]" id="input_61_5" name="q61_ojoDerecho61_6" value="OS" required="" />
        ...
        <li class="form-line form-line-column form-col-10 jf-required" data-type="control_checkbox" id="id_62">
          ...
          <div id="cid_62" class="form-input-wide jf-required" data-layout="full">
            ...
            <span class="form-checkbox-item" style="clear:left"><span class="dragger-item"></span>
            <input type="checkbox" aria-describedby="label_62" class="form-checkbox validate[required]" id="input_62_0" name="q62_ojoIzquierdo62_1" value="RM" required="" />
            <label id="label_input_62_0" for="input_62_0">RM</label></span>
            <span class="form-checkbox-item" style="clear:left"><span class="dragger-item"></span>
            <input type="checkbox" aria-describedby="label_62" class="form-checkbox validate[required]" id="input_62_1" name="q62_ojoIzquierdo62_2" value="RL" required="" />
            <label id="label_input_62_1" for="input_62_1">RL</label></span>
            <span class="form-checkbox-item" style="clear:left"><span class="dragger-item"></span>
            <input type="checkbox" aria-describedby="label_62" class="form-checkbox validate[required]" id="input_62_2" name="q62_ojoIzquierdo62_3" value="RI" required="" />
            <label id="label_input_62_2" for="input_62_2">RI</label></span>
            <span class="form-checkbox-item" style="clear:left"><span class="dragger-item"></span>
            <input type="checkbox" aria-describedby="label_62" class="form-checkbox validate[required]" id="input_62_3" name="q62_ojoIzquierdo62_4" value="RS" required="" />
            <label id="label_input_62_3" for="input_62_3">RS</label></span>
            <span class="form-checkbox-item" style="clear:left">
            <span class="dragger-item"></span><input type="checkbox" aria-describedby="label_62" class="form-checkbox validate[required]" id="input_62_4" name="q62_ojoIzquierdo62_5" value="OI" required="" />
            <label id="label_input_62_4" for="input_62_4">OI</label></span>
            <span class="form-checkbox-item" style="clear:left"><span class="dragger-item"></span>
            <input type="checkbox" aria-describedby="label_62" class="form-checkbox validate[required]" id="input_62_5" name="q62_ojoIzquierdo62_6" value="OS" required="" />
            ...
            <table summary="" aria-labelledby="label_68" cellPadding="4" cellSpacing="0" class="form-matrix-table" data-component="matrix">
              ...
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_68 label_68_row_0">
                ...
                <td class="form-matrix-values">
                  <input type="text" id="input_68_0_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q68_ojoDerecho68_1" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_68_col_0 label_68_row_0" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_68 label_68_row_1">
                ...
                <td class="form-matrix-values"><input type="text" id="input_68_1_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q68_ojoDerecho68_2" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_68_col_0 label_68_row_1" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_68 label_68_row_2">
                ...
                <td class="form-matrix-values"><input type="text" id="input_68_2_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q68_ojoDerecho68_3" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_68_col_0 label_68_row_2" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_68 label_68_row_3">
                ...
                <td class="form-matrix-values"><input type="text" id="input_68_3_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q68_ojoDerecho68_4" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_68_col_0 label_68_row_3" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_68 label_68_row_4">
                ...
                <td class="form-matrix-values"><input type="text" id="input_68_4_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q68_ojoDerecho68_5" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_68_col_0 label_68_row_4" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_68 label_68_row_5">
                ...
                <td class="form-matrix-values"><input type="text" id="input_68_5_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q68_ojoDerecho68_6" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_68_col_0 label_68_row_5" aria-label="Cells Text Box" /></td>
              </tr>
            </table>
          </div>
        </li>
          ...
          <div id="cid_70" class="form-input-wide jf-required" data-layout="full">
            <table summary="" aria-labelledby="label_70" cellPadding="4" cellSpacing="0" class="form-matrix-table" data-component="matrix">
              ...
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_70 label_70_row_0">
                ...
                <td class="form-matrix-values"><input type="text" id="input_70_0_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q70_ojoIzquierdo70_1" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_70_col_0 label_70_row_0" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_70 label_70_row_1">
                ...
                <td class="form-matrix-values"><input type="text" id="input_70_1_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q70_ojoIzquierdo70_2" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_70_col_0 label_70_row_1" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_70 label_70_row_2">
                ...
                <td class="form-matrix-values"><input type="text" id="input_70_2_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q70_ojoIzquierdo70_3" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_70_col_0 label_70_row_2" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_70 label_70_row_3">
                ...
                <td class="form-matrix-values"><input type="text" id="input_70_3_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q70_ojoIzquierdo70_4" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_70_col_0 label_70_row_3" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_70 label_70_row_4">
                ...
                <td class="form-matrix-values"><input type="text" id="input_70_4_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q70_ojoIzquierdo70_5" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_70_col_0 label_70_row_4" aria-label="Cells Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_70 label_70_row_5">
                ...
                <td class="form-matrix-values"><input type="text" id="input_70_5_0" class="form-textbox validate[required, requireEveryCell]" size="5" name="q70_ojoIzquierdo70_6" style="width:100%;box-sizing:border-box" value="" aria-labelledby="label_70_col_0 label_70_row_5" aria-label="Cells Text Box" /></td>
              </tr>
            </table>
          </div>
        </li>
      ...
      <ul class="form-section-closed" style="height: 84px;clear:both;" id="section_71">
          ...
          <div id="cid_72" class="form-input-wide jf-required" data-layout="full">
            <table summary="" aria-labelledby="label_72" cellPadding="4" cellSpacing="0" class="form-matrix-table" data-component="matrix">
              ...
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_72 label_72_row_0">
                ...
                <td class="form-matrix-values"><input type="text" id="input_72_0_0" class="form-textbox validate[required, requireEveryCell]" name="q72_rxFinal_1" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_72_col_0 label_72_row_0" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_72 label_72_row_1">
                ...
                <td class="form-matrix-values"><input type="text" id="input_72_1_0" class="form-textbox validate[required, requireEveryCell]" name="q72_rxFinal_2" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_72_col_0 label_72_row_1" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_72 label_72_row_2">
                ...
                <td class="form-matrix-values"><input type="text" id="input_72_2_0" class="form-textbox validate[required, requireEveryCell]" name="q72_rxFinal_3" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_72_col_0 label_72_row_2" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_72 label_72_row_3">
                ...
                <td class="form-matrix-values"><input type="text" id="input_72_3_0" class="form-textbox validate[required, requireEveryCell]" name="q72_rxFinal_4" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_72_col_0 label_72_row_3" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_72 label_72_row_4">
                ...
                <td class="form-matrix-values"><input type="text" id="input_72_4_0" class="form-textbox validate[required, requireEveryCell]" name="q72_rxFinal_5" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_72_col_0 label_72_row_4" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
            </table>
          </div>
        </li>
          ...
          <div id="cid_73" class="form-input-wide jf-required" data-layout="full">
            <table summary="" aria-labelledby="label_73" cellPadding="4" cellSpacing="0" class="form-matrix-table" data-component="matrix">
              ...
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_73 label_73_row_0">
                ...
                <td class="form-matrix-values"><input type="text" id="input_73_0_0" class="form-textbox validate[required, requireEveryCell]" name="q73_agudezaVisual_1" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_73_col_0 label_73_row_0" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_73 label_73_row_1">
                ...
                <td class="form-matrix-values"><input type="text" id="input_73_1_0" class="form-textbox validate[required, requireEveryCell]" name="q73_agudezaVisual_2" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_73_col_0 label_73_row_1" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
              ...
              <tr class="form-matrix-tr form-matrix-value-tr" aria-labelledby="label_73 label_73_row_2">
                ...
                <td class="form-matrix-values"><input type="text" id="input_73_2_0" class="form-textbox validate[required, requireEveryCell]" name="q73_agudezaVisual_Observaciones" style="width:100%;box-sizing:border-box" size="5" value="" aria-labelledby="label_73_col_0 label_73_row_2" step="any" aria-label="Cells Numeric Text Box" /></td>
              </tr>
            </table>
          </div>
        </li>
        ...
        <table>
                ...
                <tbody>
            <h1 style="font-size:20px ; margin-left: 25px; color: #5c6bc0;  margin-top: 10px;  margin-bottom: 20px;">Receta de Anteojos:</h1>
                    <tr>
                        <td><strong>OD</strong></td>
                        <td><input type="text" id="dni" name="OjoDerechoES" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                        <td><input type="text" id="dni" name="OjoDerechoCIL" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                        <td><input type="text" id="dni" name="OjoDerechoEJE" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                        <td><input type="text" id="dni" name="OjoDerechoADD" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                        <td><input type="text" id="dni" name="OjoDerechoAVv" style="background-color:#fff; font-size: 15px; width: 90px; height: 35px; font-weight: bold;"  required></td>
                        <td><input type="text" id="dni" name="OjoDerechoDP" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                    </tr>
                    <tr style="background-color:#fff;">
                        <td><strong>OI</strong></td>
                        <td><input type="text" id="dni" name="OjoIzquierdoES" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                        <td><input type="text" id="dni" name="OjoIzquierdoCIL" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                        <td><input type="text" id="dni" name="OjoIzquierdoEJE" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                        <td><input type="text" id="dni" name="OjoIzquierdoADD" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                        <td><input type="text" id="dni" name="OjoIzquierdoAVv" style="background-color:#fff; font-size: 15px; width: 90px; height: 35px; font-weight: bold;"  required></td>
                        <td><input type="text" id="dni" name="OjoIzquierdoDP" style="background-color:#fff; font-size: 15px; width: 110px; height: 35px; font-weight: bold;" required></td>
                    </tr>
                </tbody>
            </table>
        ...
        <li class="form-line jf-required" data-type="control_textarea" id="id_14">
          <label class="form-label form-label-top form-label-auto" id="label_14" for="input_14" aria-hidden="false"> A Facturar:<span class="form-required">*</span> </label>
          <small style="display: block; margin-top: 10px; text-align: justify; font-weight: bold; font-size: 16px;">
          Por favor, incluya aquí los detalles de los servicios médicos prestados al paciente que serán facturados, como procedimientos realizados, medicamentos recetados y cualquier otro cargo relacionado con el tratamiento.
          </small>

          <div id="cid_14" class="form-input-wide jf-required" data-layout="full">
            <div class="form-textarea-limit"><span>
              <textarea id="input_14" class="form-textarea validate[required]" name="AFacturar" style="width:648px;height:163px" data-component="textarea" required="" aria-labelledby="label_14"></textarea>
                <div class="form-textarea-limit-indicator"></div>
              </span>
            </div>
          </div>
          </li>
...
<p></p>
  ...
  input[type="submit"]:hover {
    ...
    <label for="fecha">Fecha de Proxima Cita:</label>
    <input type="date" id="fecha" name="q74_proximoControlDia" placeholder="DD-MM-YYYY" required>
    
    <label for="hora">Hora de la Cita:</label>
    <input type="time" id="hora" name="q74_proximoControlHora" required>
...
?>
        ...
        <button id="input_2" type="submit"  data-component="button" data-content="" style="background: linear-gradient(to right, #5c6bc0, #512da8); /* Azul */
        border: none;
        color: white;
        padding: 15px 32px;
        text-align: center;
        ...
        <div id="cid_2" class="form-input-wide" data-layout="full">
        <div data-align="auto" class="form-buttons-wrapper form-buttons-auto jsTest-button-wrapperField">
        <button id="input_2" data-component="button" data-content="" type="button" onclick="window.location.href = 'Listado_Reporte_Recetarios.html';" style="background: linear-gradient(to right, #5c6bc0, #512da8); /* Azul */
        border: none;
        color: white;
        padding: 15px 32px;
        text-align: center;
