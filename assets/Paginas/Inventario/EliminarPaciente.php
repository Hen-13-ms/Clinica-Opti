...
if(isset($_GET['IdProductoServicio'])) {
    ...
    $id = $_GET['IdProductoServicio'];
    $Descripcion = $_GET['Descripcion'];
    $Marca = $_GET['Marca'];
    $Categoria = $_GET['Categoria'];
    $ProductoServicio =$_GET['ProductoOServicio'];

    // Consulta SQL para eliminar el paciente
    $sql = "DELETE FROM inventario WHERE IdProductoServicio = $id";

    // Si el formulario de confirmación ha sido enviado
    if(isset($_POST['confirmacion']) && $_POST['confirmacion'] == 'SI') {

        $accion = "Se eliminó un articulo de tipo: $ProductoServicio en inventario. Articulo: $Descripcion, categoria: $Categoria, marca: $Marca.";
...
echo '<script>
    ...
    echo "<p>No se recibió el ID del registro a eliminar.</p>";
}
?>
