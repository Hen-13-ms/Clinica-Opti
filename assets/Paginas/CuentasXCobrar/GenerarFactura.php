...
if(isset($_POST['IdFacturaPorCobrar'])) {
    // Obtener el ID del paciente a eliminar
    $IdFacturaPorCobrar= $_POST['IdFacturaPorCobrar'];
    ...
    $sql = "DELETE FROM cuentasxcobrar WHERE IdFacturaPorCobrar = $IdFacturaPorCobrar";
...
// Consulta SQL para insertar el registro en la tabla "factura"
$insertar = "INSERT INTO factura VALUES (
    '', '', '$nombre', '$cedula', '', '', '', '', '$metodoPago', '$fechaConsulta', '', '', '', '', '', '', '', '', '$TotalAPagar', '$PagoRealizado', '$PagoADevolver', '', '')";

// Ejecutar la consulta de inserción
if ($conn->query($insertar) === TRUE) {
    echo "Registro insertado correctamente en la tabla 'factura'";
} else {
...
<body>
    <div class="factura">
        ...
        <div class="cliente">
            ...
            <p><strong>Fecha de Consulta:</strong> <?php echo $fechaFormateada; ?></p>
