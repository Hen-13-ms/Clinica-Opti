...
if(isset($_GET['IdFacturaPorCobrar'])) {
    $IdFacturaPorCobrar = $conn->real_escape_string($_GET['IdFacturaPorCobrar']);
    
    // Consulta para obtener los datos del paciente específico
    $sql = "SELECT * FROM cuentasxcobrar WHERE IdFacturaPorCobrar = '$IdFacturaPorCobrar'";
    $resultado = $conn->query($sql);

    if($resultado->num_rows == 1) {
        $IdFacturaPorCobrar = $resultado->fetch_assoc(); // Obtiene los datos del paciente
       
        $id = $IdFacturaPorCobrar['IdFacturaPorCobrar'];
        $nombre = $IdFacturaPorCobrar['NombrePacientee'];
        $cedula = $IdFacturaPorCobrar['Cedula'];
        $RestanteAPagar= $IdFacturaPorCobrar['RestanteAPagar'];
    ...
    <div class="container">
        ...
        <div class="right-column"></div>      
            ...
            <form id="formularioFactura" action="GenerarFactura.php" method="post" style="margin-left: 200px;">
                ...
                <input type="text" name="IdFacturaPorCobrar" value="<?php echo $id; ?>">
                ...
                <input type="text" id="nombre" name="nombre" style="font-size: 15px;" required readonly value="<?php echo $nombre;?>">
                ...
                <!-- <input type="hidden" type="date" id="fechaConsultaa" name="fechaConsulta" style="font-size: 15px;" onchange="calcularFechaExpiracion()" required> -->
                ...
                <input type="number" id="TotalAPagar" name="TotalAPagar" style="font-size: 20px;" required readonly value="<?php echo $RestanteAPagar;?>">
